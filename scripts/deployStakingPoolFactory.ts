...
// Goerli
const agiCoinAddress = '0xa49573920bd91e61bd46669059E80288FB44FAa0';
const esagiTokenAddress = '0x6bCdeB6457982b26A244521CC3A129571BAB8D22';
const wethAddress = '0xb4fbf271143f4fbf7b91a5ded31805e42b2208d6';

async function main() {
  const StakingPoolFactory = await ethers.getContractFactory("StakingPoolFactory");
  const contract = await StakingPoolFactory.deploy(esagiTokenAddress, wethAddress);
